...
private[csv] class CsvReader(params: CSVOptions) {
  ...
  private val parser: CsvParser = {
    ...
    settings.setIgnoreLeadingWhitespaces(params.ignoreLeadingWhiteSpaceInRead)
    settings.setIgnoreTrailingWhitespaces(params.ignoreTrailingWhiteSpaceInRead)
...
private[csv] class LineCsvWriter(params: CSVOptions, headers: Seq[String]) extends Logging {
  ...
  format.setQuoteEscape(params.escape)
  format.setComment(params.comment)
  writerSettings.setIgnoreLeadingWhitespaces(params.ignoreLeadingWhiteSpaceFlagInWrite)
  writerSettings.setIgnoreTrailingWhitespaces(params.ignoreTrailingWhiteSpaceFlagInWrite)
